            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="./assets/img/img-1.png" alt="First slide">
                </div>
              ...
              <div class="row">
                ...
                <div class="card">
                    <div class="row">
                      ...
                      <div class="col-md-4 col-3">
                      <img src="./assets/img/wanita.png" class="img-fluid" alt="Responsive image">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                    <div class="row">
                      ...
                      <div class="col-md-4 col-3">
                      <img src="./assets/img/anak.png" class="img-fluid" alt="Responsive image">
                      </div>
                    </div>
                  </div>
                </div>
